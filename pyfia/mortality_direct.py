...
def _calculate_group_totals(
    all_plots: pl.DataFrame, plot_mort: pl.DataFrame, join_cols: List[str]
) -> pl.DataFrame:
    ...
    full_data = all_plots.join(
        ...
        on=[
            ...
            if col in all_plots.columns and col in plot_mort.columns
        ],
        how="left",
    ).with_columns(
        [
