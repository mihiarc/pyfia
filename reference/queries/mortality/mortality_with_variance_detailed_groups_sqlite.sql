Shivanselect eval_grp,
  ...
  from (select pop_eval_grp_cn,
         ...
         group by phase_1_summary.pop_eval_grp_cn,
                  ...
                  phase_1_summary.n,
                  phase_summary.spcd,
                  phase_summary.spgrpcd,
                  phase_summary.owngrpcd,
                  phase_1_summary.estn_unit,
                  phase_summary.agentcd,
                  phase_summary.dstrbcd1,
                  phase_summary.dstrbcd2,
                  phase_summary.dstrbcd3) estimate_by_estn_unit
