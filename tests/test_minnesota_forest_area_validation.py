...
from pyfia.estimation.area_workflow import AreaWorkflow, area_workflow
...
class TestMinnesotaForestAreaValidation:
    ...
    def test_original_area_function_matches_reference(self, fia_instance, query_interface):
        ...
        print("   Location: Minnesota (STATECD = 27)")
        print("   Land type: Forest")
        ...
        if abs(actual_area - expected_reference) <= 1000:  # Within 1,000 acres
            print("✅ PERFECT MATCH - pyFIA function produces documented reference value!")
            return actual_area
    ...
    def test_area_workflow_matches_original_and_reference(self, fia_instance, query_interface):
        ...
        print("   Using LangGraph state management")
        print("   With validation and error recovery")
...
def run_minnesota_area_validation():
    ...
    print("📊 Running Minnesota Forest Area Validation")
    ...
    try:
        ...
        print("   Advanced workflow validated against reference data")
