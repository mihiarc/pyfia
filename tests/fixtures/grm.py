    ...
    return pl.DataFrame(
        {
            ...
            "AGENTCD": [
                ...
                30,
                10,
            ],  # Fire, Insect, Weather, Disease, Fire, Insect
        }
    )
...
def subptyp_grm_mappings():
    ...
    return {
        ...
        1: {
            "name": "SUBP",
            "description": 'Subplot adjustment (typically 5.0-24.0" DBH)',
        },
        2: {
            "name": "MICR",
            "description": 'Microplot adjustment (typically <5.0" DBH)',
        },
        3: {
            "name": "MACR",
            "description": 'Macroplot adjustment (typically >=24.0" DBH)',
        },
    }
