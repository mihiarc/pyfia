...
#### `carbon_flux` <sup><a href="https://github.com/mihiarc/pyfia/blob/main/src/pyfia/core/fia.py#L1300" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
carbon_flux(self, **kwargs) -> pl.DataFrame
```
